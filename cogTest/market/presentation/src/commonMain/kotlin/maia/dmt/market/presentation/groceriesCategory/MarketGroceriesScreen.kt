...
import dmtproms.cogtest.market.presentation.generated.resources.cogTest_market_category_conserves
...
import dmtproms.cogtest.market.presentation.generated.resources.cogTest_market_category_oils
...
private fun getCategoryName(nameResId: String): String {
    return when (nameResId) {
        ...
        "cogTest_market_category_conserves" -> stringResource(Res.string.cogTest_market_category_conserves)
        "cogTest_market_category_vegetables" -> stringResource(Res.string.cogTest_market_category_vegetables)
        "cogTest_market_category_oils" -> stringResource(Res.string.cogTest_market_category_oils)
        ...
        MarketGroceriesScreen(
            state = MarketGroceriesState(
                categoryList = listOf(
                    ...
                    CategoryItem(
                        "dry_spices",
                        "cogTest_market_category_dry_spices",
                        "market_dry_spices_icon"
                    ),
                    CategoryItem(
                        "vegetables",
                        "cogTest_market_category_vegetables",
                        "market_vegetables_icon"
                    ),
                    ...
                    CategoryItem(
                        "cleaning",
                        "cogTest_market_category_cleaning_disposable",
                        "market_cleaning_icon"
                    ),
                )
            ),
            onAction = {}
