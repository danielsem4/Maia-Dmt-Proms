...
import maia.dmt.core.data.localization.KtorLanguageService
...
val coreDataModule = module {
    ...
    singleOf(::KtorFileUploadService) bind FileUploadService::class
    ...
    singleOf(::KtorLanguageService) bind LanguageService::class
